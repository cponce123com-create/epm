...
function SectionHeadingColored({
  title,
  color,
  href,
}: {
...
function SkeletonCard() {
  return (
    <div className="news-card">
      <div
        className="skeleton-shimmer w-full mb-3"
...
export default function Home() {
  ...
  const [externalHeadlines, setExternalHeadlines] = useState<
    ExternalHeadline[]
  >([]);
  ...
  return (
    <div className="min-h-screen" style={{ background: "var(--epm-paper)" }}>
      <Helmet>
        <title>
          El Príncipe Mestizo · Comunicación ciudadana desde la selva central
        </title>
        <meta
          name="description"
          content="Periodismo ciudadano desde San Ramón, Chanchamayo (Perú). Opinión, denuncia e investigación."
        />
        ...
        <div style={{ minHeight: 340 }} className="lg:min-h-[680px]">
          {!loadingFeatured && hero && (
            ...
            >
              ...
              >
                {/* Cabecera */}
                <div
                  className="epm-mono epm-panel-article"
                  style={{
                    paddingBottom: 14,
                      ...
                      {art.coverImageUrl ? (
                        ...
                        <div
                          style={{
                            ...
                            flexShrink: 0,
                            background:
                              "repeating-linear-gradient(135deg, rgba(255,255,255,0.04) 0 12px, rgba(255,255,255,0.02) 12px 13px)",
                          }}
                        />
                      )}
                    </a>
          ...
          {loadingFeatured && (
            <div
              ...
              style={{ borderBottom: "1px solid #D6CFBF" }}
            >
                ...
                >
                  ...
                  >
                    <h2
                      ...
                      onMouseEnter={(e) =>
                        ((e.target as HTMLElement).style.color = "#7A1F1F")
                      }
                      onMouseLeave={(e) =>
                        ((e.target as HTMLElement).style.color = "#15140F")
                      }
                    >
                      {art.title}
                    </h2>
              ...
              return (
                <div key={cat.id} className="mb-10">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-[2fr_1fr] gap-x-5">
                    <div
                      className="md:pr-5 md:border-r"
                      style={{ borderColor: "#D6CFBF" }}
                    >
                      <ArticleCard
                        article={toArticle(main)}
                        size="lg"
                        showSummary
                      />
                    </div>
                        ...
                        <div style={{ padding: 0 }}>
                          ...
                          <div style={{ padding: 20 }}>
                            ...
                            >
                              <span>▌ {hl.source}</span>
                              <span
                                style={{ color: "#8A857C", fontWeight: 400 }}
                              >
                                {(() => {
                                  try {
                ...
                <>
                  ...
                  {latestArticles && latestArticles.totalPages > 1 && (
                    ...
                    >
                      ...
                      <span
                        className="epm-mono px-3"
                        style={{ fontSize: 11, color: "#8A857C" }}
                      >
                      ...
                      <button
                        onClick={() => {
                          setPage((p) =>
                            Math.min(latestArticles.totalPages, p + 1),
                          );
                          window.scrollTo({ top: 0, behavior: "smooth" });
                        }}
