...
import { Upload, FileArchive, CheckCircle, XCircle, AlertCircle, Loader2 } from "lucide-react";
  ...
  return (
    <AdminLayout>
      <div className="max-w-2xl mx-auto">
        ...
        {/* Instructions */}
        <div className="mb-6 p-4 bg-blue-50 border border-blue-100 rounded-lg text-sm text-blue-800 font-sans-ui space-y-1">
          <p className="font-semibold">¿Cómo exportar desde Medium?</p>
        ...
        <div className="bg-card border border-border rounded-xl p-6 space-y-6">
          ...
          <div>
            ...
            {loadingCats ? (
              <div className="text-sm text-muted-foreground font-sans-ui">Cargando categorías…</div>
            ) : (
              <select
                value={categoryId}
          ...
          <div>
            ...
            <div className="flex gap-4">
              <label className="flex items-center gap-2 text-sm font-sans-ui cursor-pointer">
                ...
                />
                Borrador (recomendado — revisar antes de publicar)
              </label>
              <label className="flex items-center gap-2 text-sm font-sans-ui cursor-pointer">
                <input
                  type="radio"
          ...
          <div className="mt-6 bg-card border border-border rounded-xl p-6">
              ...
              {response.results.map((r, i) => (
                ...
                >
                  ...
                  <div>
                    ...
                    {r.reason && <p className="text-xs opacity-80">{r.reason}</p>}
                  </div>
                </div>
              ))}
            </div>
            ...
            {defaultStatus === "draft" && response.imported > 0 && (
              <p className="mt-4 text-xs text-muted-foreground font-sans-ui">
                ...
                <a href="/admin/articles" className="underline text-primary">Artículos</a> para revisarlos y publicarlos.
              </p>
            )}
          </div>
        )}
