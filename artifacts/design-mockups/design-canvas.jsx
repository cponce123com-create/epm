...
function DesignCanvas({ children, minScale, maxScale, style }) {
  ...
  // skipNextWrite suppresses writes until the next read.
  const [didRead, setDidRead] = React.useState(false);
  const [skipNextWrite, setSkipNextWrite] = React.useState(false);

  // Additional logic for reading and writing state would go here...

  return (
    <DCCtx.Provider value={{ state, setState }}>
      <div style={{ ...style, background: DC.bg }}>
        {children}
      </div>
    </DCCtx.Provider>
  );
